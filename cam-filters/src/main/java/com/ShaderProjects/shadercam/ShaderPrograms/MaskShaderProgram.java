...
public class MaskShaderProgram extends Shader {
    ...
    public MaskShaderProgram(Context context, VideoRenderer renderer) {
    ...
    public void init(){
        ...
        maskTexture = loadTexture(context, R.drawable.mask);
    ...
    private void drawMasks() {
        ...
        for(int i: keys) {
            ...
            mat.translate(x, y, 0).scale(width, height, 0.0f).scale(.9f, .9f, 0.0f).rotateZ((float)fWrapper.getAngle() + 3.14f);
